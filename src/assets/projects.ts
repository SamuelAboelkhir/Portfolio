export const projects = {
  1: {
    title: "BookStore",
    description: "My Biggest project yet, with more planned updates to come. A fullstack project featuring a frontend portion created using the mantine component library for react, typsecript, and tailwindcss. The backend portion is created using express.js and node.js.",
    image: "/images/BookStore.png",
    link: "https://github.com/BlackDovah/BookStore"
  },
  2: {
    title: "React simple calculator",
    description: "A calculator created using React and tailwindcss as my very first project.",
  ...
  5: {
    ...
    link: "https://github.com/BlackDovah/MedicalManagerApp"
},
}
